...
sample_mc_inner_gibbs_rw <- function(f, z, y, t, NMC, u0, proposal_SD, batch, trace) {
    .Call('_glmmPen_sample_mc_inner_gibbs_rw', PACKAGE = 'glmmPen', f, z, y, t, NMC, u0, proposal_SD, batch, trace)
}
