...
grp_CD_XZ_FA <- function(y, X, Z, group, pBigMat, J_f, dims, beta, offset, family, link, init, phi, X_group, K, penalty, params, trace) {
    .Call('_glmmPen_grp_CD_XZ_FA', PACKAGE = 'glmmPen', y, X, Z, group, pBigMat, J_f, dims, beta, offset, family, link, init, phi, X_group, K, penalty, params, trace)
}
...
Qfun_FA_B <- function(y, X, Z, pBigMat, group, J_f, beta, offset, dims, family, link, sig_g, phi) {
    .Call('_glmmPen_Qfun_FA_B', PACKAGE = 'glmmPen', y, X, Z, pBigMat, group, J_f, beta, offset, dims, family, link, sig_g, phi)
}
