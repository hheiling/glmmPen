...
Summary: It looks like once the acceptance rate was already low, increasing the proposal variance / SD didn't increase the acceptance rates (or at least not enough to reach the desired area of (0.4, 0.5)), so the proposal SD / variance kept increasing to its upper bound with no obvious effect.
