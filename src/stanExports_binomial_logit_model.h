...
namespace model_binomial_logit_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_binomial_logit_model");
    reader.add_event(18, 16, "end", "model_binomial_logit_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_binomial_logit_model
  : public stan::model::model_base_crtp<model_binomial_logit_model> {
private:
        int N;
        int q;
        vector_d eta_fef;
        ...
        matrix_d Z;
public:
    model_binomial_logit_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binomial_logit_model_namespace::model_binomial_logit_model";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "eta_fef", "vector_d", context__.to_vec(N));
            eta_fef = Eigen::Matrix<double, Eigen::Dynamic, 1>(N);
            vals_r__ = context__.vals_r("eta_fef");
            pos__ = 0;
            size_t eta_fef_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < eta_fef_j_1_max__; ++j_1__) {
                eta_fef(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                alpha = in__.vector_constrain(q, lp__);
            else
                alpha = in__.vector_constrain(q);
            // model body
            current_statement_begin__ = 14;
            lp_accum__.add(normal_log<propto__>(alpha, 0, 1));
            current_statement_begin__ = 15;
            lp_accum__.add(bernoulli_logit_log<propto__>(y, add(eta_fef, multiply(Z, alpha))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_binomial_logit_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha = in__.vector_constrain(q);
        size_t alpha_j_1_max__ = q;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_binomial_logit_model";
    }
...
typedef model_binomial_logit_model_namespace::model_binomial_logit_model stan_model;
#ifndef USING_R
