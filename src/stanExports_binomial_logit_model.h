...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 5, column 26 to column 27)",
...
class model_binomial_logit_model final : public model_base_crtp<model_binomial_logit_model> {
private:
  int N;
  int q;
...
public:
  ...
  inline std::string model_name() const final { return "model_binomial_logit_model"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_binomial_logit_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alpha = in__.vector(q);
      {
        ...
        lp_accum__.add(
          bernoulli_logit_lpmf<propto__>(y, add(eta_fef, multiply(Z, alpha))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
using stan_model = model_binomial_logit_model_namespace::model_binomial_logit_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_binomial_logit_model_namespace::profiles__;
}
#endif
#endif
