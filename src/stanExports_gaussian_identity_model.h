...
class model_gaussian_identity_model
  : public stan::model::model_base_crtp<model_gaussian_identity_model> {
private:
        int N;
        int q;
        vector_d eta_fef;
...
public:
    ...
    std::string model_name() const {
        return "model_gaussian_identity_model";
    }
...
typedef model_gaussian_identity_model_namespace::model_gaussian_identity_model stan_model;
#ifndef USING_R
