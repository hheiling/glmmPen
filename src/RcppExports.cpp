...
NumericMatrix sample_mc_inner_gibbs_test(arma::mat f, arma::mat z, arma::vec y, arma::vec t, int NMC, arma::vec u0, arma::rowvec proposal_var, int trace);
RcppExport SEXP _glmmPen_sample_mc_inner_gibbs_test(SEXP fSEXP, SEXP zSEXP, SEXP ySEXP, SEXP tSEXP, SEXP NMCSEXP, SEXP u0SEXP, SEXP proposal_varSEXP, SEXP traceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type f(fSEXP);
    ...
    Rcpp::traits::input_parameter< arma::rowvec >::type proposal_var(proposal_varSEXP);
    Rcpp::traits::input_parameter< int >::type trace(traceSEXP);
    rcpp_result_gen = Rcpp::wrap(sample_mc_inner_gibbs_test(f, z, y, t, NMC, u0, proposal_var, trace));
    return rcpp_result_gen;
END_RCPP
}
// arma_test_value
