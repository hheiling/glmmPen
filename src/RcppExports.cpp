...
// sample_mc_inner_gibbs_test
NumericMatrix sample_mc_inner_gibbs_test(arma::mat f, arma::mat z, arma::vec y, arma::vec t, int NMC, arma::vec u0, arma::rowvec proposal_SD, int trace);
RcppExport SEXP _glmmPen_sample_mc_inner_gibbs_test(SEXP fSEXP, SEXP zSEXP, SEXP ySEXP, SEXP tSEXP, SEXP NMCSEXP, SEXP u0SEXP, SEXP proposal_SDSEXP, SEXP traceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type f(fSEXP);
    ...
    Rcpp::traits::input_parameter< arma::rowvec >::type proposal_SD(proposal_SDSEXP);
    Rcpp::traits::input_parameter< int >::type trace(traceSEXP);
    rcpp_result_gen = Rcpp::wrap(sample_mc_inner_gibbs_test(f, z, y, t, NMC, u0, proposal_SD, trace));
    return rcpp_result_gen;
END_RCPP
}
// sample_mc_inner_gibbs_rw
NumericMatrix sample_mc_inner_gibbs_rw(arma::mat f, arma::mat z, arma::vec y, arma::vec t, int NMC, arma::vec u0, arma::rowvec proposal_SD, double batch, int trace);
RcppExport SEXP _glmmPen_sample_mc_inner_gibbs_rw(SEXP fSEXP, SEXP zSEXP, SEXP ySEXP, SEXP tSEXP, SEXP NMCSEXP, SEXP u0SEXP, SEXP proposal_SDSEXP, SEXP batchSEXP, SEXP traceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type f(fSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type batch(batchSEXP);
    Rcpp::traits::input_parameter< int >::type trace(traceSEXP);
    rcpp_result_gen = Rcpp::wrap(sample_mc_inner_gibbs_rw(f, z, y, t, NMC, u0, proposal_SD, batch, trace));
    return rcpp_result_gen;
END_RCPP
}
// arma_test_value
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_glmmPen_sample_mc_inner_gibbs_test", (DL_FUNC) &_glmmPen_sample_mc_inner_gibbs_test, 8},
    {"_glmmPen_sample_mc_inner_gibbs_rw", (DL_FUNC) &_glmmPen_sample_mc_inner_gibbs_rw, 9},
