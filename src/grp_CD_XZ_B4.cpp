...
// Change from grp_CD_XZ_B3: 
// Instead of updating eta after every beta_j update and the consequent re-calc of the residuals,
// update the residuals as specified in the grpreg and ncvreg paper (to speed things up)
// Update eta and residuals at end part of while loop
...
// [[Rcpp::export]]
arma::vec grp_CD_XZ_B4(const arma::vec& y, const arma::mat& X, const arma::mat& Z,
