...
class model_poisson_log_model final : public model_base_crtp<model_poisson_log_model> {
private:
  int N;
  int q;
...
public:
  ...
  inline std::string model_name() const final { return "model_poisson_log_model"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_poisson_log_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alpha = in__.vector(q);
      {
        ...
        lp_accum__.add(
          poisson_log_lpmf<propto__>(y, add(eta_fef, multiply(Z, alpha))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
using stan_model = model_poisson_log_model_namespace::model_poisson_log_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_poisson_log_model_namespace::profiles__;
}
#endif
#endif
