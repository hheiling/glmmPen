...
namespace model_poisson_log_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_poisson_log_model");
    reader.add_event(18, 16, "end", "model_poisson_log_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_poisson_log_model
  : public stan::model::model_base_crtp<model_poisson_log_model> {
private:
        int N;
        int q;
        vector_d eta_fef;
        ...
        matrix_d Z;
public:
    model_poisson_log_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_poisson_log_model_namespace::model_poisson_log_model";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(poisson_log<propto__>(y, stan::math::exp(add(eta_fef, multiply(Z, alpha)))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_poisson_log_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_poisson_log_model";
    }
...
typedef model_poisson_log_model_namespace::model_poisson_log_model stan_model;
#ifndef USING_R
