...
// Goal: Make equivalent to sample_mc_gibbs_adapt_rw, but outputs a big.matrix
// See Znew_gen2 function in test_glmmPen.cpp for strategy
// // [[Rcpp::export]]
// void sample_mc_gibbs_adapt_rw_BigMat(arma::mat f, // matrix
//                                      arma::mat z, // matrix
//                                      arma::vec y, // vector
//                                      int NMC, // integer
//                                      arma::vec u0, //matrix
