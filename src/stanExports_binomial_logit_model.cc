...
#include "stanExports_binomial_logit_model.h"

RCPP_MODULE(stan_fit4binomial_logit_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_binomial_logit_model")
