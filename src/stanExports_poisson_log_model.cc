...
#include "stanExports_poisson_log_model.h"

RCPP_MODULE(stan_fit4poisson_log_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_poisson_log_model")
