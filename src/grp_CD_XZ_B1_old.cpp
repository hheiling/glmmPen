...
// [[Rcpp::export]]
arma::vec grp_CD_XZ_B1_old(const arma::vec& y, const arma::mat& X, const arma::mat& Z,
  ...
  arma::rowvec u(q); // A single row from the posterior matrix (extract from pBigMat)
